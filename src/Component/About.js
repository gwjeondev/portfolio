...
const About = () => {
  ...
  const [info, setInfo] = useState([
    ...
    },
    {
      id: 5,
      text:
        "주변에 아주 가까운 것 부터 모든 것들이 웹으로 이루어져 있습니다. \
      만약 웹이 없는 시대에서 살아간다면요? 생각조차 할 수 없겠죠? \
      저는 이러한 개발자가 되고 싶습니다. 어떻게 하면 사용자가 사용하기 편리할지 \
      어떻게 하면 내가 속한 집단에 도움을 가져다 줄수 있을지, 어떻게 하면 \
      이 어플리케이션이 최고가 될지 끝 없이 생각하는 개발자가 되고 싶습니다.\
      제가 하고자 하는 일이 정말 너무나 재미있습니다. \
      저의 이러한 열정을 귀사에 발전에 도움이 될 수 있게 열심히 달리겠습니다. \
