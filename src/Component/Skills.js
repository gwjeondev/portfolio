  ...
  const [skillset, setSkillset] = useState([
      {
          id:1,
          title:'HTML',
          img:'https://raw.githubusercontent.com/won-developer/img/master/HTML.png',
          level:'intermediate',
          text:''
      },
      {
      ...
      },
      {
          id:4,
          title:'React',
          img:'https://raw.githubusercontent.com/won-developer/img/master/REACT_1.png',
          level:'basic',
          text:''
      },
      {
    ...
    <div className="skills">
      <div className="skills__container">
          ...
          <ul className="skills__list skill">
              {skillset.map(value => {
              return <li className={`skills__list--${value.id} skills--list`} key={value.id}>
                  <div className={`skill__inner--${value.title}`}><Image src={value.img} alt={value.title}/><span>{value.level}</span></div>
              </li>
              })}
          </ul>
      </div>
